    ...
    <footer className="bg-black text-white">
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          {/* Magazine links */}
          <div>
            <h3 className="text-xs font-semibold tracking-wider uppercase mb-4">Magazine</h3>
          ...
          {/* Shop links */}
          <div>
            <h3 className="text-xs font-semibold tracking-wider uppercase mb-4">Shop</h3>
            <ul className="space-y-3">
          ...
          {/* Company links */}
          <div>
            <h3 className="text-xs font-semibold tracking-wider uppercase mb-4">Company</h3>
            <ul className="space-y-3">
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          <p className="text-xs text-gray-500 text-center">
            &copy; {new Date().getFullYear()} Routure Magazine. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
